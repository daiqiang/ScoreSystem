...
if(cookies!=null){
	for(int i=0;i<cookies.length;i++){
	    if(cookies[i].getName().equals("cookie_user")){
		    ...
		    if(value!=null && !"".equals(value) && value.split("\\^").length>1){
...
<html>
  ...
  <body>
    ...
    <form id="form" action="loginAction" method="post" onsubmit="return check()">
    	学号/工号：<input id="username" name="username" type="text"/><br/>
    	密码：<input id="password" name="password" type="password"/><br/>
    	<label><input type="checkbox" name="flag" id="flag" onclick="isRemember(this)" value ="0" />记住我的登陆状态</label><br/><br/>
